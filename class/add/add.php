...
class add
{
	...
	public function sign_student($sid_number, $s_fname, $s_lname, $s_gender, $s_contact, $s_email, $s_department, $s_major, $s_year, $s_section, $s_password, $type)
	{
		global $conn;
	...
	public function sign_faculty($f_id, $f_fname, $f_lname, $f_gender, $f_contact, $f_email, $f_department, $f_password, $type)
	{
		global $conn;
	...
	public function add_newstudent($sid_number, $s_password, $s_fname, $s_lname, $s_gender, $s_contact, $s_email, $s_department, $s_major, $s_year, $s_section)
	{
		...
		if ($sql_count <= 0) {
			...
			$insert = $conn->prepare('INSERT INTO member(m_school_id,m_password, m_fname, m_lname, m_gender, m_contact,m_email, m_department, m_year_section, m_type) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?);
						INSERT INTO history_logs(description,table_name,user_id,user_type) VALUES(?,?,?,?)');
			$insert->execute(array($sid_number, $s_password, $s_fname, $s_lname, $s_gender, $s_contact, $s_email, $s_department, $s_year . ' - ' . $s_section, $type, $h_desc, $h_tbl, $sessionid, $sessiontype));
			$insert_count = $insert->rowCount();
...
switch ($key) {
	...
	case 'add_newstudent';
		...
		$add_function->add_newstudent($sid_number, $s_password, $s_fname, $s_lname, $s_gender, $s_contact, $s_email, $s_department, $s_major, $s_year, $s_section);
		break;
