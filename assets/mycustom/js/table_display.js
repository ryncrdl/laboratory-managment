var table_room = $(".table_room").DataTable({
  ...
  buttons: [
    ...
    },
    {
      ...
      message:
        '<img src="https://i.imgur.com/RB6tXS4.png" height="100px" width="100px" style="position: absolute;top:0px;left:80px;"><center style="margin: 1rem 0rem;"><h4 style="margin-top:-40px;">REPUBLIC OF THE PHILIPPINES</h4>\
      ...
      customize: function (win) {
        $(win.document.body)
          .find("table")
          .append(
            '<br<br/><br><br><br><h4 class="">Noted by:</h4><br><br><br><br><br><h4 class="">Prepared by:</h4>'
          );
      },
    },
  ],
...
var table_inventory_new = $(".table_inventory_new").DataTable({
  ...
  buttons: [
    ...
    },
    {
      ...
      message:
        '<img src="http://4.bp.blogspot.com/_5ydAHJv4lKc/TSm6Sr4vMWI/AAAAAAAAAAQ/B3oGPh3_26k/s1600/logo.png" height="100px" width="100px" style="position: absolute;top:0;left:80px;"><center><h4 style="margin-top:-40px;">REPUBLIC OF THE PHILIPPINES</h4>\
...
var table_inventory_all = $(".table_inventory_all").DataTable({
  ...
  buttons: [
    ...
    },
    {
      ...
      message:
        "<center><h4>REPUBLIC OF THE PHILIPPINES</h4>\
														<h5>CARLOS HILADO MEMORIAL STATE COLLEGE</h5>\
														<h6>DEPARTMENT OF INFORMATION SYSTEMS</h6>\
														</center>",
      customize: function (win) {
...
var room_tbl_completed = $(".room_tbl_completed").DataTable({
  ajax: {
    url: "../class/display/display",
    type: "POST",
    data: function (d) {
      d.key = "display_room_completed";
      d.month = selectMonthData();
      d.year = selectYearData();
    },
  },
...
var room_tbl_pendingres = $(".room_tbl_pendingres").DataTable({
  ajax: {
    url: "../class/display/display",
    type: "POST",
    data: {
      key: "pending_room_reservation",
    },
  },
  columns: [
    {
...
var room_tbl_reserved = $(".room_tbl_reserved").DataTable({
  ajax: {
    url: "../class/display/display",
    type: "POST",
    data: {
      key: "accept_room_reservation",
    },
  },
  columns: [
    {
