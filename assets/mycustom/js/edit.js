...
table_member.on('click', 'a.edit-member', function(e){
	...
	var form = '<form class="frm_student_sign">\
					...
					<div class="form-group">\
						...
						<input type="password" name="s_password" class="form-control" required autocomplete="off">\
					</div>\
					<div class="form-group">\
					...
					<div class="form-group">\
						...
						<div class="form-group">\
						<label>Email</label>\
						<input type="email" name="s_email" value="'+tr[11]+'" class="form-control" required autocomplete="off">\
					</div>\
					<div class="form-group">\
