...
<head>
	...
	<title>PUP Laboratory Management System</title>
	<!-- Logo -->
	...
	<link rel="stylesheet" type="text/css" href="./assets/mycustom/css/custom.css">
</head>
			...
			<div class="col-md-12">
				<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-5 col-md-offset-4">
					<div class="login-panel panel panel-default">
						<img src="views/logo.png"  class="text-center w-25"/>
						<div class="panel-heading text-center ">PUP Laboratory Management System</div>
						<div class="panel-body">
							<form class="frm_index">
								<fieldset>
									...
									<br>
									<a href="./member/login" style="color: #800000 !important;"> Login as Member's</a>
								</fieldset>
							</form>
						</div>
					</div>
