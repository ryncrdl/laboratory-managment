...
<head>
	...
	<title>PUP LMS | Member Verification</title>
	<!-- Logo -->
		...
		<div class="panel">
			<div class="panel-body">
				...
				<div class="col-md-4 col-sm-12 col-xs-12 col-md-offset-4"
					...
					<form class="frm_member_verification" style="padding: 2rem;">
						...
						<div class="form-group">
							...
							<input type="number" name="code" class="form-control" required autofocus="on">
						</div>
						<div class="form-group">
