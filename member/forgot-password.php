...
<head>
	...
	<title>PUP LMS | Forgot Password</title>
	<!-- Logo -->
		...
		<div class="panel">
			<div class="panel-body">
				...
				<div class="col-md-4 col-sm-12 col-xs-12 col-md-offset-4"
					...
					<form class="frm_member_forgotpassword" style="padding: 2rem;">
						...
						<h4 class="alert bg-primary text-center">Forgot Password</h4>
						...
						<div class="form-group">
							<label>Email</label>
							<input type="email" name="m_email" class="form-control" required autofocus="on">
						</div>
						<div class="form-group">
							<button class="btn btn-primary" style="display: block; width: 100%;">Verify</button>
							<br>
						</div>
